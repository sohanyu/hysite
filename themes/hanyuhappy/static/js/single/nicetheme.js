...
jQuery(document).ready(function($) {
	...
	loadJS('https://static.is26.com/tmp/iDisqus.min.js', function() {
...
var General = {
	...
	webFontLoader: function() {
		WebFontConfig = {
			...
			custom: {
				families: ['Exo', 'iconfont2'],
				urls: ['https://static.is26.com/tmp/iDisqus.min.css']
			}
		};
		loadJS('https://static.is26.com/tmp/webfont.js', function() {
			WebFont.load({
				custom: {
					families: ['Exo', 'iconfont2']
				}
